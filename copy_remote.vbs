'===========================
strServer = "torbigdata01.example.com"
...
strDestDir = "\\torbigdata01.example.com\e$\Data_Processor\"				'Double backslash used to access network shares with UNC naming scheme.	
