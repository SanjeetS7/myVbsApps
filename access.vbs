'===========================
strServer = "abc01-qa.example.com"
strUsername = "username@us"	'InputBox("Enter the user name to access " & strServer, "Network Username", "username@domain")
strPassword = "password"	'InputBox("Enter the password for the user " & strUsername, "Network Password")
...
strSourceFile = "C:\Users\453562\Desktop\loginfo.txt"
            strDestDir = "\\abcsql01-qa.example.com\e$\Data_Manager_Backup\"				'Double backslash used to access network shares with UNC naming scheme.	
